...
Linguax: Knowledge Testing System: AI-Powered Computer-Adaptive Mastery-Based Quizzing from Any PDF

Linguax: Knowledge Testing System is a fully functional Streamlit web app that automatically generates personalized, mastery-driven quizzes from any uploaded PDF (lecture notes, textbook excerpts, etc). Built with Deepseek's R1-0528 API, the app uses generative AI to create high-quality, curriculum-agnostic assessments with adaptive difficulty and real-time feedback.

Why It Matters: The Pedagogy Behind Linguax: Knowledge Testing System

Linguax: Knowledge Testing System is more than just an AI demo — it’s grounded in proven learning science and addresses three fundamental gaps in current edtech tools:
...
Linguax: Knowledge Testing System operationalizes this by ending quizzes only when a student demonstrates mastery — defined as correctly answering 5+ questions at high difficulty (Level 6+) with at least 75% accuracy.
...
Linguax: Knowledge Testing System uses predicted student accuracy (e.g. “72% of students likely get this right”) to adjust quiz difficulty in real time, starting at ~70% and adapting up or down after each response.
...
Linguax: Knowledge Testing System builds in immediate feedback with explanations after every question, reinforcing learning via active recall and self-explanation.

How It Works

Upload Content
Educators upload a PDF (e.g., lecture notes, textbook chapters).
...
Why Linguax: Knowledge Testing System Is Unique

No Rigid Curricula: Unlike ALEKS or IXL, Linguax: Knowledge Testing System works with any input content.
...
Tested with Gemini-2.5 Pro with Blind Evaluation of Deepseek-R1 naive prompting questions versus Linguax: Knowledge Testing System questions- showed an average question quality of 8.4/10 vs 7.6/10 and average cognitive depth of 5.1/10 vs 3.1/10- showed 0.873 Sperman's Rank Correlation between Linguax: Knowledge Testing System difficulty tiers and Gemini predictions, showing that difficulty adaptation is very close to perfect
